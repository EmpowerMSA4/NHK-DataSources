...
// Ignore Spelling: Multicast Gqi
namespace GetMulticastConnections_1
{
	using System;
	...
	[GQIMetaData(Name = "GetMulticastConnections")]
	public class MyDataSource : IGQIDataSource, IGQIInputArguments, IGQIOnInit
	{
		...
		public GQIColumn[] GetColumns()
		{
			...
			{
				new GQIStringColumn("Source EID"),
				new GQIStringColumn("Source IF"),
				new GQIStringColumn("Source Name"),
				new GQIStringColumn("Destination EID"),
				new GQIStringColumn("Destination IF"),
				new GQIStringColumn("Destination Name"),
					...
					foreach (var outgoingIf in multicastRoute.OutgoingInterfaces)
					{
						...
						var newRow = new GQIRow(
							new[]
							{
								...
								new GQICell { Value = parsedIfOut },
								new GQICell { Value = mellanox.DmsElement.Name },
								new GQICell { Value = remoteSwitch.DmsElement.DmsElementId.Value },
								new GQICell { Value = lldpConnection.RemoteIf },
								new GQICell { Value = lldpConnection.RemoteName },
